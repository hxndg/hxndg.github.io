...
2. 而write.ouput函数实际上是拿到FeedbackOutputStream，顾名思义，有回馈的outputstream，调用write.getOutput来获取FeedbackOutputStream，这个地方可能有个小坑，这个write的实现在src/main/java/build/buildfarm/cas/cfc/CASFileCache.java里面。
