...
Locking support detected on remote "origin". Consider enabling it with:
  $ git config lfs.https://xxxxxxxxxxx-v2.git/info/lfs.locksverify true
ref HEAD:: missing object: 044cc804064cb9f121c90577285a9f2d5e6ac749
Uploading LFS objects: 100% (31471/31471), 6.1 GB | 1.4 MB/s, done.
error: failed to push some refs to 'xxxxxxxxxxxxxxx.git'
git push [MAP-CI-DAILY/20230715_2359] failed.
```

我们是根目录下面建立一个文件叫做/xxxxx，然后在代码路径下面ln了一个软连接叫做/path/to/code/xxxxx，在软连接里面push就稳定失败，在根目录下面做push就没事，具体为啥没问题我也不太明白。。。
