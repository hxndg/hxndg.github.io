...
+ 阅读Debug Hacks中文版，格蠹汇编，软件调试 第2版 卷1：硬件基础，阅读抽象方面的书籍：《编程原本》《SICP》《代码整洁之道》《Refactoring: Improving the Design of Existing Code(重构)》《软件方法》《Modern C++ Design》《FROM MATHEMATICS TO GENERIC PROGRAMMING》
+ 学习BPF性能分析，进度，书买了，没时间看，基本网络知识还没构成体系
+ 分布式存储和分布式计算
+ 学习构建自己的调试工具库valgrind
+ 《C++primer》的类设计者工具，《linux虚拟内存管理》lru管理部分，《深入浅出DPDK》虚拟内存管理，
